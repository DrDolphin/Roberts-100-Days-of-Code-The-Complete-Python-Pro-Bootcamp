    ...
    for letter in start_text:
        if letter in alphabet:
            if cipher_direction == "encode":
                new_letter_index = (
                    letter_to_number[letter] + shift_amount
                ) % alphabet_length
            else:
                new_letter_index = (
                    letter_to_number[letter] - shift_amount
...
while should_continue:
    ...
    if direction == "encode" or direction == "decode":
        ...
        print(
            f"{direction} is not a valid function. Please run it again and make sure to choose a valid option."
        )

    like_to_continue = input(
